...
class FM_DEMOD(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq = center_freq = 70000000

        ##################################################
        # Blocks
        ##################################################
        self._center_freq_range = Range(70000000, 105000000, 100000, 70000000, 200)
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.qtgui_freq_sink_x_0_1_0, 0))
        self.connect((self.iio_pluto_source_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))
